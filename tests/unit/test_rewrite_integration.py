...
"""
    ...
    # Check Imports
    assert "from airflow.operators.empty import EmptyOperator" in generated_code
    assert "from airflow.operators.python import PythonOperator" in generated_code
